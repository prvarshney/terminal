...
public class StudentRecoverPassword2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_recover_password2);
        ...
        newPasswordEye.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(newEyeTogglerFlag){
                    ...
                    newPasswordEye.setImageResource(R.drawable.ic_password_eye_crossed_image);
                } else{
                    newPasswordEditText.setTransformationMethod(new PasswordTransformationMethod());
                    newEyeTogglerFlag = true;
                    newPasswordEye.setImageResource(R.drawable.ic_password_eye_image);
                }
            }
        }));
        ...
        saveChangesBtn.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!otpValue.equals("") && !newPasswordValue.equals("") && !confirmPasswordValue.equals("") && (newPasswordValue.equals(confirmPasswordValue))){
                    final ProgressButton progressButton = new ProgressButton(StudentRecoverPassword2.this,saveChangesBtn);
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    if (res.status == 401 || res.status==204 ) {
                                        ...
                                        attentionRequiredTowardsInvalid.setAlpha(0);
                                            invalidAttemptFlag = false;
                                            startActivity(new Intent(StudentRecoverPassword2.this, MainActivity.class));
                                    }
                                }
                            },
